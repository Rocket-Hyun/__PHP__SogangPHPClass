...
if ($connect ->query($sql) === TRUE) {
  ...
  echo "<tr><td>".$idnumber."</td><td>".$idnumber."</td><td>".$name."</td><td>".$row["name"]."</td><td>".$email."</td><td>".$phone."</td> <td>".$topping1."</td><td>".$topping2."</td><td>".$topping3."</td><td>".$paymethod."</td><td>".$callfirst."</td></tr>";
} else {
