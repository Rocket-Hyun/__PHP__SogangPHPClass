...
if ($result->num_rows > 0) {
  while($row = $result->fetch_assoc()) {
    echo "<tr><td>".$row["ordernumber"]."</td><td>".$row["idnumber"]."</td><td>".$row["name"]."</td><td>".$row["email"]."</td><td>".$row["phone_number"]."</td> <td>".$row["topping1"]."</td><td>".$row["topping2"]."</td><td>".$row["topping3"]."</td><td>".$row["pay_method"]."</td><td>".$row["call_first"]."</td></tr>";
  }
}
